...
public static class Lorenz
{
    ...
    static double s_x = 5.0;
    static double s_y = 2.0;
    static double s_z = 27.0;

    static int s_nsteps = Iterations;
    static double s_h = -1.0;
    static int s_printDerivative = -1;
    ...
    static double F(double t, double x, double y, double z)
    {
        return (10.0 * (y - x));
    }

    static double G(double t, double x, double y, double z)
    {
        return (x * (28.0 - z) - y);
    }

    static double H(double t, double x, double y, double z)
    {
