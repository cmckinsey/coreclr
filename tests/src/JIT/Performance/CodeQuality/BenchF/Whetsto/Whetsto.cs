...
public static class Whetsto
{
    ...
    static int s_j, s_k, s_l;
    static double s_t, s_t2;

    public static volatile int Volatile_out;

    static void Escape(int n, int j, int k, double x1, double x2, double x3, double x4)
    {
        Volatile_out = n;
        Volatile_out = j;
        Volatile_out = k;
    ...
    static void P3(double x, double y, out double z)
    {
        x = s_t * (x + y);
        y = s_t * (x + y);
        z = (x + y) / s_t2;
