...
public static class LLoops
{
    ...
    static void MinV1(float[] a, ref int n, out float d, float[] l, float[] m)
    {
        float biga, hold;
    ...
    static void MinV2(float[] a, ref int n, out float d, float[] l, float[] m)
    {
        float biga, hold;
        int i, j, k;
    ...
    static void MProd(float[] a, float[] b, float[] c, ref int n)
    {
        int i, j, k;
    ...
    static void CompM(float[] a, float[] b, ref int n)
    {
        int i, j;
        float x, sum = 0.0F;
